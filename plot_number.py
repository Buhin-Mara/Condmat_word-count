...
f = open('count_word_2018.csv',encoding="utf-8")
g = open('count_word_2017.csv',encoding="utf-8")
h = open('count_word_2013.csv',encoding="utf-8")
i = open('count_word_2008.csv',encoding="utf-8")
j = open('count_word_2003.csv',encoding="utf-8")
k = open('count_word_1998.csv',encoding="utf-8")
